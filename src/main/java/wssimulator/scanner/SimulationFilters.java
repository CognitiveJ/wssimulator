...
public final class SimulationFilters {
    ...
    @NotNull
    public static CompositeFilter filters(@NotNull SimulationFilter... simulationFilters) {
    ...
    @NotNull
    public static FilterSimulationsByPackagePrefix byPackagePrefix(@NotNull String prefix) {
        return new FilterSimulationsByPackagePrefix(prefix);
    }

    @NotNull
    public static FilterByPath byPath(@NotNull String pathFilter) {
