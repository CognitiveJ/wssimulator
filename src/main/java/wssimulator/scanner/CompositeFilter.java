...
public class CompositeFilter implements SimulationFilter {
    ...
    public CompositeFilter(@NotNull SimulationFilter... filters) {
    ...
    public List<SearchFilter> searchFilters() {
        return filterList.stream()
                .filter(simulationFilter -> simulationFilter instanceof SearchFilter)
                .map(simulationFilter -> (SearchFilter) simulationFilter).collect(Collectors.toList());
    }

    @NotNull
    public List<SimulationContentFilter> simulationContentFilters() {
        return filterList.stream()
                .filter(simulationFilter -> simulationFilter instanceof SimulationContentFilter)
                .map(simulationFilter -> (SimulationContentFilter) simulationFilter).collect(Collectors.toList());
