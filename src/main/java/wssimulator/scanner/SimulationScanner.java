...
public class SimulationScanner {
    ...
    static class ContentFilterPredicate implements Predicate<WSSimulation> {
        ...
        public boolean test(WSSimulation wsSimulation) {
            boolean includeSimulation = true;
            for (int i = 0; i < simulationContentFilters.size() && includeSimulation; i++) {
                SimulationContentFilter simulationContentFilter = simulationContentFilters.get(i);
                if (simulationContentFilter.exclude(wsSimulation))
